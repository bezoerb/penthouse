...
describe("penthouse pre formatting tests", () => {
  it("should remove non matching media queries", () => {
    ...
    const largeTest = [
      {
        rules: [...mediaToRemoveAlways, ...mediaToRemoveUnlessKeepLarge],
        remove: true,
      },
      {
    ...
    let keepLargeMediaQueriesErrors = testMediaQueryRemoval(
      keepLargeMediaQueriesTest,
      1300,
      900,
      true,
    );
